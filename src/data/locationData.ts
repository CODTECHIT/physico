...
export const locationData: Record<string, LocationInfo> = {
  ...
  'manikonda': {
    name: 'Manikonda',
    title: 'Expert Physiotherapy at Home in Manikonda',
    description: 'Top-rated home visit physiotherapy in Manikonda. Specialized in back pain, sports injuries, and neuro rehabilitation.',
    keywords: 'physiotherapy in Manikonda, home visit physiotherapist Manikonda, physiotherapist near me'
  },
  'jubilee-hills': {
    name: 'Jubilee Hills',
    title: 'Premium Home Physiotherapy in Jubilee Hills',
    description: 'World-class physiotherapy services delivered to your home in Jubilee Hills. Specialized care for post-surgery and pain management.',
    keywords: 'physiotherapy in Jubilee Hills, home visit physiotherapist Jubilee Hills, best physiotherapist near me'
  },
  'banjara-hills': {
    name: 'Banjara Hills',
