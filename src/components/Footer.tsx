          ...
          <div className="col-span-2 space-y-5 rounded-3xl border border-white/10 bg-white/[0.03] p-5 lg:col-span-1 lg:space-y-8 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              {[
                ...
                { icon: <Youtube className="w-5 h-5" />, link: YOUTUBE_LINK, hover: 'hover:bg-[#FF0000]', label: 'YouTube' },
                { icon: <Linkedin className="w-5 h-5" />, link: LINKEDIN_LINK, hover: 'hover:bg-[#0A66C2]', label: 'LinkedIn' },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.link}
