...
import { CheckCircle2, ArrowRight, Activity, Stethoscope, Brain, Heart, Target, Zap } from 'lucide-react';
...
const servicesData = {
  ...
  'cupping': {
    ...
    desc: 'Expert Dry Needling & Cupping Therapy at Home in Kukatpally & Miyapur. At Flexo Physio, our certified physiotherapists deliver personalized treatments designed to relieve deep muscle tension, accelerate recovery, and restore mobility through safe, effective, and modern clinical techniques.',
      ...
      <section className="pt-20 pb-8 lg:pt-32 lg:pb-16 relative overflow-hidden min-h-[45vh] lg:h-[60vh] flex items-center">
        ...
        >
          <img 
            ...
            alt="Flexo Physio Service Detail Background"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="space-y-12 lg:space-y-16">
              ...
              <div className="pt-6">
                <a 
                  href={`${CONTACT_WHATSAPP_LINK}?text=${encodeURIComponent(`Hi Flexo Physio, I would like to book a specialist for ${service.title}.`)}`}
                  target="_blank"
      ...
      <section className="py-12 lg:py-16 bg-surface/50 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-10 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 pt-8">
            <a 
              href={`${CONTACT_WHATSAPP_LINK}?text=${encodeURIComponent(`Hi Flexo Physio, I am not sure which service I need for ${service.title}. I need a consultation.`)}`}
              target="_blank"
              rel="noopener noreferrer"
